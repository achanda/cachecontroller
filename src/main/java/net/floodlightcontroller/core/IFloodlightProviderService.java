...
import net.floodlightcontroller.cachemanager.HTTPRequest;
...
public interface IFloodlightProviderService extends IFloodlightService {
    ...
    public Multimap<String, HTTPRequest> requests = ArrayListMultimap.create();
    //public Cache selectedCache = null;
    public Jedis connection = new Jedis("localhost");
